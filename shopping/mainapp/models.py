...
class Product(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        #     raise MinResolutionErrorException('Разрешение изображения меньше {}x{} '.format(min_height, min_width))
        # if img.height > max_height or img.width > max_width:
        #     raise MaxResolutionErrorException('Разрешение изображения больше {}x{}'.format(max_height, max_width))
        image = self.image
        img = Image.open(image)
